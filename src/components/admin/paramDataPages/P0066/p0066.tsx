...
const P0066 = forwardRef((props: any, ref) => {
  ...
  const {sendRequest : sendFlagRequest , status: getFlagResponseStatus ,  data: getFlagResponse , error:getFlagResponseError} = useHttp(getData, true); 
  ...
  useEffect(() => {
    let getDataParams:any = {}
        ...
        getDataParams.item = "FLAG";
        sendFlagRequest({apiUrlPathSuffix : '/basicservices/paramItem' , getDataParams :getDataParams});
          ...
          <tr key={index}>
            <td>
              <TextField
                ...
                value={value.name}
                onChange={(e) =>
                  fieldChangeHandler(index, "name", e.target.value,false)
                }
                fullWidth
                size="small"
                type="text"
            ...
            <td>
              <TextField
                ...
                onChange={(e) =>
                  fieldChangeHandler(index, "dialCode", e.target.value,false)
                }
                fullWidth
                size="small"
                type="text"
            ...
            <td>
              <TextField
                ...
                value={value.code}
                onChange={(e) =>
                  fieldChangeHandler(index, "code", e.target.value,false)
                }
                fullWidth
                size="small"
                type="text"
            ...
            <td>
              <TextField
                ...
                value={value.flag}
                onChange={(e) =>
                  fieldChangeHandler(index, "flag", e.target.value,false)
                }
                fullWidth
                size="small"
                type="text"
              ...
              >
                {getFlagResponse?.param.data.dataPairs.map((value:any) => (
