...
const Q0012 = forwardRef((props: any, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    getData() {
      ...
      setInputdata((inputdata: any) => ({
        ...inputdata,
        sbRates: inputdata.sbRates.filter((value: any) => value.term !== ""),
      }));
  ...
  return (
    <Table striped bordered hover>
      <h1>
        {" "}
        <center>Term Based Survival Benefit Rates </center>
      </h1>
      <thead
        style={{
