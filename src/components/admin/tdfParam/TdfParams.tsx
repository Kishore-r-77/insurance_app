...
import {
  ...
  columns,
  initialValues,
} from "../../../reducerUtilities/actions/admin/tdfParam/tdfParamsActions";
import styles from "./tdfParam.module.css";
import {
  addApi,
  deleteApi,
  editApi,
  getAllApi,
} from "./tdfParamApis/tdfParamsApis";
import TdfParamsModal from "./tdfParamModal/TdfParamsModal";
import Notification from "../../../utilities/Notification/Notification";

function TdfParams({ modalFunc }: any) {
  ...
  const reducer = (state: TdfParamsStateType, action: any) => {
    switch (action.type) {
  ...
  const getData = () => {
    return getAllApi(pageNum, pageSize, state)
      .then((resp) => {
        ...
        setData(resp.data["AllTDFParam"]);
        settotalRecords(resp.data.paginationData.totalRecords);
        // ***  Attention : Check the API and modify it, if required   ***
        setisLast(resp.data["AllTDFParam"]?.length === 0);
