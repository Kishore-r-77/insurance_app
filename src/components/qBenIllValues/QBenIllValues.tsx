...
import {
  ...
  columns,
  initialValues,
} from "../../reducerUtilities/actions/qBenIllValues/qBenIllValuesActions";
import styles from "./qBenIllValue.module.css";
import {
  addApi,
  deleteApi,
  editApi,
  getAllApi,
} from "./qBenIllValuesApis/qBenIllValuesApis";
import QBenIllValuesModal from "./qBenIllValuesModal/QBenIllValuesModal";
import Notification from "../../utilities/Notification/Notification";

function QBenIllValues({ modalFunc }: any) {
  ...
  const reducer = (state: QBenIllValuesStateType, action: any) => {
    switch (action.type) {
  ...
  const getData = () => {
    return getAllApi(pageNum, pageSize, state)
      .then((resp) => {
        ...
        setData(resp.data["All QBenIllValuess"]);
        settotalRecords(resp.data.paginationData.totalRecords);
        // ***  Attention : Check the API and modify it, if required   ***
        setisLast(resp.data["All QBenIllValuess"]?.length === 0);
