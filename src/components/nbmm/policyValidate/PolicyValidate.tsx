...
import { addApi, deleteApi, editApi, getAllApi} from "../nbmmApis/policyValidateApis";
...
import PolicyValidateModal from "../nbmmModal/PolicyValidateModal";
import PolicyValidateTable from "./PolicyValidateTable";


function PolicyValidate({ data, modalFunc }: any) {
