...
import {
  ...
  columns,
  initialValues,
} from "../../reducerUtilities/actions/qHeader/qHeadersActions";
import styles from "./qHeaders.module.css";
import {
  addApi,
  deleteApi,
  editApi,
  getAllApi,
} from "./qHeaderApis/qHeadersApis";
import QHeadersModal from "./qHeaderModal/QHeadersModal";
import Notification from "../../utilities/Notification/Notification";

function QHeaders({ modalFunc }: any) {
  ...
  const reducer = (state: QHeadersStateType, action: any) => {
    switch (action.type) {
