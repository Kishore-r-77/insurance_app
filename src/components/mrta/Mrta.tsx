...
//  columns,
//  initialValues,
// } from "../../reducerUtilities/actions/mrta/mrtaActions";
// import styles from "./mrta.module.css";
// import { addApi, deleteApi, editApi, getAllApi } from "./mrtaApis/mrtaApis" ;
// import MrtaModal from "./mrtaModal/MrtaModal";


// function Mrta({ modalFunc }: any) {
//   //data from getall api
//   const [data, setData] = useState([]);
//   //data got after rendering from table
//   const [record, setRecord] = useState<any>({});
//   //Reducer Function to be used inside UserReducer hook
//   const reducer = (state: MrtaStateType, action: any) => {
//     switch (action.type) {
