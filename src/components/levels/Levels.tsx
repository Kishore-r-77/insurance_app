...
import {
  ...
  columns,
  initialValues,
} from "../../reducerUtilities/actions/levels/levelsActions";
import styles from "./levels.module.css";
import { addApi, deleteApi, editApi, getAllApi } from "./levelsApis/levelsApis";
import LevelsModal from "./levelsModal/LevelsModal";

function Levels({ modalFunc }: any) {
  //data from getall api
  const [data, setData] = useState([]);
  //data got after rendering from table
  const [record, setRecord] = useState<any>({});
  //Reducer Function to be used inside UserReducer hook
  const reducer = (state: LevelsStateType, action: any) => {
    switch (action.type) {
      ...
      case ACTIONS.LEVELSOPEN:
        return {
          ...state,
          levelsOpen: true,
        };
      case ACTIONS.LEVELSCLOSE:
        return {
          ...state,
          levelsOpen: false,
        };
