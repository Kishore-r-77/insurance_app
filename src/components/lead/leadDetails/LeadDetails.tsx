...
import {
  ...
  columns,
  initialValues,
} from "../../../reducerUtilities/actions/lead/leadDetails/leadDetailsActions";
...
import {
  ...
  editApi,
  getAllApi,
} from "./leadDetailsApis/leadDetailsApis";
import LeadDetailsModal from "./leadDetailsModal/LeadDetailsModal";

function LeadDetails({ modalFunc }: any) {
  //data from getall api
  const [data, setData] = useState([]);
  //data got after rendering from table
  const [record, setRecord] = useState<any>({});
  //Reducer Function to be used inside UserReducer hook
  const reducer = (state: LeadDetailsStateType, action: any) => {
    switch (action.type) {
      ...
      case ACTIONS.LEADCHANNELSOPEN:
        return {
          ...state,
          leadChannelsOpen: true,
        };
      case ACTIONS.LEADCHANNELSCLOSE:
        return {
          ...state,
