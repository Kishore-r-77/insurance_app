...
import {
  ...
  columns,
  initialValues,
} from "../../../reducerUtilities/actions/lead/leadAllocations/leadAllocationsActions";
import styles from "./leadAllocations.module.css";
import {
  addApi,
  deleteApi,
  editApi,
...
export default LeadAllocations;
