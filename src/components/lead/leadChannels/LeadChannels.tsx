...
import {
  ...
  columns,
  initialValues,
} from "../../../reducerUtilities/actions/lead/leadChannels/leadChannelsActions";
import styles from "./leadChannels.module.css";
import {
  addApi,
  deleteApi,
  editApi,
  getAllApi,
} from "./leadChannelsApis/leadChannelsApis";
import LeadChannelsModal from "./leadChannelsModal/LeadChannelsModal";
import Notification from "../../../utilities/Notification/Notification";

function LeadChannels({ modalFunc }: any) {
  ...
  const reducer = (state: LeadChannelsStateType, action: any) => {
    switch (action.type) {
