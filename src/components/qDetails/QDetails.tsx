...
import {
  ...
  columns,
  initialValues,
} from "../../reducerUtilities/actions/qDetails/qDetailsActions";
import styles from "./qDetails.module.css";
import {
  addApi,
  deleteApi,
  editApi,
  getAllApi,
} from "./qDetailsApis/qDetailsApis";
import QDetailsModal from "./qDetailsModal/QDetailsModal";

function QDetails({ modalFunc }: any) {
  //data from getall api
  const [data, setData] = useState([]);
  //data got after rendering from table
  const [record, setRecord] = useState<any>({});
  //Reducer Function to be used inside UserReducer hook
  const reducer = (state: QDetailsStateType, action: any) => {
    switch (action.type) {
