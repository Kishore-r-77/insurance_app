...
import {
  ...
  columns,
  initialValues,
} from "../../../reducerUtilities/actions/campaigns/campaignsActions";
...
import {
  ...
  editApi,
  getAllApi,
} from "./campaignApis/campaignsApis";
import styles from "./campaigns.module.css";
import CampaignsModal from "./campaignsModal/CampaignsModal";
  ...
  const getData = () => {
    return getAllApi(pageNum, pageSize, state)
      .then((resp) => {
        ...
        // ***  Attention : Check the API and modify it, if required   ***
        setisLast(resp.data["All Campaigns"]?.length === 0);
